...
cp run/valence_extractor_output/{items,misc}.json ../crates/valence_protocol/extracted/
cp run/valence_extractor_output/{registry_codec.json,tags.json} ../crates/valence_registry/extracted/
